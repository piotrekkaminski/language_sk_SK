...
# Version & progress
This translation is generated from the branch [Head](https://crowdin.com/project/magento-2/sk#/Head) at Crowdin and based on the Magento Head sourcefiles.
...
# Contribute
To help move the '*Slovak (slovenčina) Magento2 Language Pack (sk_SK)*' forward please goto [this](https://crowdin.com/project/magento-2/sk) crowdin page and translate the untranslated string or propose better translations.
